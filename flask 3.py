...
def pageone():
    ...
    graph_html = pio.to_html(fig, full_html=False)  # Convert to an HTML snippet
    
    # Pass the HTML graph to the template
    return render_template('pageone.html', plot=graph_html)
